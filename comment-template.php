...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields = array(
		'author' => sprintf(
			...
			sprintf(
				'<input placeholder="Autor (*)" id="author" name="author" type="text" value="%s" size="30" maxlength="245"%s />',
	...
	$defaults = array(
		...
		'comment_field'        => sprintf(
			...
			'<textarea placeholder="Twój komentarz =)" id="comment" name="comment" cols="45" rows="8" maxlength="65525" required="required"></textarea>'
		),
		'must_log_in'          => sprintf(
		...
		'submit_button'        => '<input class="btn btn-success" name="%1$s" type="submit" id="%2$s" class="%3$s" value="%4$s" />',
